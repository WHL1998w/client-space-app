	...
	<div class="background-color bl-col">
		<div class="carousel-wrap">
			...
			<div class="carousel-items">
				<span v-for="(item,index) in sliders" :key="index"
		...
		<div class="bl-container bl-row container bl-shadow">
			<div class="bl-col-2 left">
				<div class="bl-card bl-shadow">
					<div class="bl-card-header bl-col">
						<img class="left-top-images" src="../assets/image/iceland.jpg" />
						<img class="avatar-max avatar-images" src="../assets/image/avatar-dhg.png" />
					</div>
					<div class="bl-card-body bl-card-body1">
						<h1>NickName</h1>
						<h3 class="text-color-gray">个性签名</h3>
					</div>
			...
			<div class="bl-col-6 main">
				...
				<div class="bl-row dynamic bl-shadow">
					<div class="bl-col-4">
						<h1>说说</h1>
					</div>
					<div class="bl-col-4">
				...
				<div class="box bl-col bl-shadow">
					<div class="content bl-shadow">
						<div class="box1 bl-row">
							<div class="bl-col-1">
								<img src="../assets/image/instagram_3.jpg" class="avatar-min" />	
							</div>
							<div class="bl-col-9">
								<h2>NickName</h2>
								<h3>12:00</h3>							
